...
export default function StoreScreen() {
  const [items, setItems] = useState<Array<{ id: string; title: string; price: string; icon: string }>>([
    ...
    <ScreenContainer>
      ...
      <FlatList
        ...
        renderItem={({ item }: { item: any }) => (
          <GlassCard style={styles.item} padding={spacing.md}>
